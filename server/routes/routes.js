...
const { GetMyOrder, UploadPrescription, checkCouponCode, CreateOrder, VerifyPaymentOrder } = require('../Controller/Order.controller');
const { addNewAddress, getMyAddresses, updateMyAddress, deleteMyAddress } = require('../Controller/address.controller');
